...
class BibleFactory: NSObject {
    ...
    static func getAllList() -> [BibleVOM] {
        ...
        chapterList.append(BibleVOM(engName: "Numbers", korName: "민수기", chapters: 36, versesPerChapter: [54,34,51,49,31,27,89,26,23,36,35,16,33,45,41,35,28,32,22,29,35,41,30,25,19,65,23,31,39,17,54,42,56,29,34,13]))
        ...
        chapterList.append(BibleVOM(engName: "1 Kings", korName: "열왕기상", chapters: 22, versesPerChapter: [53,46,28,20,32,38,51,66,28,29,43,33,34,31,34,34,24,46,21,43,29,54]))
        ...
        chapterList.append(BibleVOM(engName: "1 Chronicles", korName: "역대상", chapters: 29, versesPerChapter: [54,55,24,43,41,66,40,40,44,14,47,41,14,17,29,43,27,17,19,8,30,19,32,31,31,32,34,21,30]))
        chapterList.append(BibleVOM(engName: "2 Chronicles", korName: "역대하", chapters: 36, versesPerChapter: [18,17,17,22,14,42,22,18,31,19,23,16,23,14,19,14,19,34,11,37,20,12,21,27,28,23,9,27,36,27,21,33,25,33,26,23]))
        chapterList.append(BibleVOM(engName: "Ezra", korName: "에스라", chapters: 10, versesPerChapter: [11,70,13,24,17,22,28,36,15,44]))
        chapterList.append(BibleVOM(engName: "Nehemiah", korName: "느헤미야", chapters: 13, versesPerChapter: [11,20,38,17,19,19,72,18,37,40,36,47,31]))
        chapterList.append(BibleVOM(engName: "Esther", korName: "에스더", chapters: 10, versesPerChapter: [22,23,15,17,14,14,10,17,32,3,17,8,30,16,24,10]))
        chapterList.append(BibleVOM(engName: "Job", korName: "욥기", chapters: 42, versesPerChapter: [22,13,26,21,27,30,21,22,35,22,20,25,28,22,35,22,16,21,29,29,34,30,17,25,6,14,21,28,25,31,40,22,33,37,16,33,24,41,30,32,26,17]))
        chapterList.append(BibleVOM(engName: "Psalms", korName: "시편", chapters: 150, versesPerChapter: [6,11,9,9,13,11,18,10,21,18,7,9,6,7,5,11,15,51,15,10,14,32,6,10,22,11,14,9,11,13,25,11,22,23,28,13,40,23,14,18,14,12,5,27,18,12,10,15,21,23,21,11,7,9,24,14,12,12,18,14,9,13,12,11,14,20,8,36,37,6,24,20,28,23,11,13,21,72,13,20,17,8,19,13,14,17,7,19,53,17,16,16,5,23,11,13,12,9,9,5,8,29,22,35,45,48,43,14,31,7,10,10,9,8,18,19,2,29,176,7,8,9,4,8,5,6,5,6,8,8,3,18,3,3,21,26,9,8,24,14,10,8,12,15,21,10,20,14,9,6]))
        ...
        chapterList.append(BibleVOM(engName: "Isaiah", korName: "이사야", chapters: 66, versesPerChapter: [31,22,26,6,30,13,25,23,20,34,16,6,22,32,9,14,14,7,25,6,17,25,18,23,12,21,13,29,24,33,9,20,24,17,10,22,38,22,8,31,29,25,28,28,25,13,15,22,26,11,23,15,12,17,13,12,21,14,21,22,11,12,19,11,25,24]))
        ...
        chapterList.append(BibleVOM(engName: "Daniel", korName: "다니엘", chapters: 12, versesPerChapter: [21,49,100,34,30,29,28,27,27,21,45,13,64,42]))
        ...
        chapterList.append(BibleVOM(engName: "Joel", korName: "요엘", chapters: 3, versesPerChapter: [20,27,5,21]))
        ...
        chapterList.append(BibleVOM(engName: "Acts", korName: "사도행전", chapters: 28, versesPerChapter: [26,47,26,37,42,15,60,40,43,48,30,25,52,28,41,40,34,28,40,38,40,30,35,27,27,32,44,31]))
